...
function downloadExcelSample(){
    ...
    form.setAttribute('method', 'post');
    form.setAttribute('action', "/CUSTOMER/Customer_Category_Management/sample-excel-list")
    document.body.appendChild(form);
    form.submit();
    document.body.removeChild(form);
...
function fileSubmit(){
        ...
        var request = $.ajax({
            url:"/CUSTOMER/Customer_Category_Management/uploadlist",
            type:"POST",
            data:formData,
            processData:false,
            contentType: false,
...
//        postData.desc = $('#pop_desc_drop').val();
        ...
        var request = $.ajax({
            url:"/CUSTOMER/ip-customer-category-list",
            type:"POST",
            data:postData,
            success: function(data, status){
                $('#demo-foo-filtering').DataTable().ajax.reload();
...
//        postData.desc = $('#pop_desc_drop').val();
        ...
        var request = $.ajax({
            url:"/CUSTOMER/Customer_Category_Management/"+ postData.seq,
            type:"PUT",
            data:postData,
            success: function(data, status){
                $('#demo-foo-filtering').DataTable().ajax.reload();
...
function deleteItem(){
    ...
    if( result) {
        ...
        var request = $.ajax({
            url: "/CUSTOMER/Customer_Category_Management/" + row.seq,
            type: "DELETE",
            success: function (data, status) {
                //alert('success');
                $('#demo-foo-filtering').DataTable().ajax.reload();
...
function GetList(){
    if ($('#demo-foo-filtering').length !== 0) {
       var dtTable = $('#demo-foo-filtering').DataTable({
                ajax: {
                    url:"/CUSTOMER/Customer_Category_Management/list",
                    type:"POST",
                    "data": function (d) {
...
//                }
            ...
            "drawCallback" : function(setting,data){
                ...
                var theTableName = "customerCategoryManagement";
                 setTimeout(function(){
