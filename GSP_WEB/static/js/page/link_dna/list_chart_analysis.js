var tooltip = d3.select("body")
    ...
    function reloadData() {
        ...
        url = '/chart/rowdatalist/' + datasource + '?search_ip=' + search_ip + '&max_nodes_size=1000'
        var postData = makePostData();
        var str_pass_data = "";
        for (var _data in postData) {
            str_pass_data += "&" + _data + "=" + postData[_data];
        }
        ...
        d3.json(url, function (error, json) {
            ...
            node.on("mouseover", function (d) {
                ...
                nodetooltip.transition()
                    .duration(300)
                    .style("opacity", .9);
                tooltipHtml = ("<p>{0} IP : {1}</p><p>세션수 : {2}</p>")
                    .format(d.type ,d.name, d.conCount.toLocaleString());
            ...
            link.on("mouseover", function (d) {
                ...
                tooltip.transition()
                    .duration(300)
                    .style("opacity", .9);
                tooltipHtml = "<p>Server {0} Client {1}</p>".format(d.source.name, d.target.name);
                tooltipHtml += "<p>프로파일 {0} </p>"
                        .format(nullToDesc(d.profile));
                tooltipHtml += "<p>프로토콜 {0} </p>"
                    .format(d.protocol.toLocaleString(undefined, {maximumFractionDigits:2}));
                tooltipHtml += "<p>송신량 {0} %, {1}</p>"
                    .format(d.s_bytes_p.toLocaleString(undefined, {maximumFractionDigits:2})
                    , getReadableFileSizeString(d.s_bytes));
                tooltipHtml += "<p>수신량 {0} %, {1}</p>"
                    .format(d.r_bytes_p.toLocaleString(undefined, {maximumFractionDigits:2})
                    , getReadableFileSizeString(d.r_bytes));
                tooltipHtml += "<p>송신 패킷수 {0} %, {1}</p>"
                    .format(d.s_pkts_p.toLocaleString(undefined, {maximumFractionDigits:2})
                    , d.s_pkts.toLocaleString(undefined, {maximumFractionDigits:2}));
                tooltipHtml += "<p>수신 패킷수 {0} %, {1}</p>"
                    .format(d.r_pkts_p.toLocaleString(undefined, {maximumFractionDigits:2})
                    , d.r_pkts.toLocaleString(undefined, {maximumFractionDigits:2}));
                tooltipHtml += "<p>세션 유지시간 {0} sec</p>"
                    .format(d.s_time.toLocaleString(undefined, {maximumFractionDigits:2}));
                tooltipHtml += "<p>세션 수 {0} </p>"
                    .format(d.s_count.toLocaleString(undefined, {maximumFractionDigits:2}));
                tooltipHtml += "URG: {0}%, {1} / ACK: {2}%, {3} / PSH: {4}%, {5} / RST: {6}%, {7} / SYN: {8}%, {9} / FIN: {10}%, {11}".format(
                    d.tcp_urg_p.toLocaleString(undefined, {maximumFractionDigits:2})
                    , d.tcp_urg.toLocaleString(undefined, {maximumFractionDigits:2})
                    , d.tcp_ack_p.toLocaleString(undefined, {maximumFractionDigits:2})
                    , d.tcp_ack.toLocaleString(undefined, {maximumFractionDigits:2})
                    , d.tcp_psh_p.toLocaleString(undefined, {maximumFractionDigits:2})
                    , d.tcp_psh.toLocaleString(undefined, {maximumFractionDigits:2})
                    , d.tcp_rst_p.toLocaleString(undefined, {maximumFractionDigits:2})
                    , d.tcp_rst.toLocaleString(undefined, {maximumFractionDigits:2})
                    , d.tcp_syn_p.toLocaleString(undefined, {maximumFractionDigits:2})
                    , d.tcp_syn.toLocaleString(undefined, {maximumFractionDigits:2})
                    , d.tcp_fin_p.toLocaleString(undefined, {maximumFractionDigits:2})
                    , d.tcp_fin.toLocaleString(undefined, {maximumFractionDigits:2})
                );
                tooltipHtml += "<p>지리적 거리 {0} km</p>".format(
                    d.distance.toLocaleString(undefined, {maximumFractionDigits:2})
                );
