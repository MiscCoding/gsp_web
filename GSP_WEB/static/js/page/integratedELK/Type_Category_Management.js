...
function downloadExcel(){
    ...
    form.setAttribute('action', "/ELK/Type_Category/excel-list")
...
function downloadExcelSample(){
    ...
    form.setAttribute('method', 'post');
    form.setAttribute('action', "/ELK/Type_Category/sample-excel-list")
    document.body.appendChild(form);
    form.submit();
    document.body.removeChild(form);
...
function fileSubmit(){
        ...
        var request = $.ajax({
            url:"/ELK/Type_Category/uploadlist",
            type:"POST",
            data:formData,
            processData:false,
            contentType: false,
...
//        postData.desc = $('#pop_desc_drop').val();
        ...
        var request = $.ajax({
            url:"/ELK/Type_Category/"+ postData.seq,
            type:"PUT",
            data:postData,
            success: function(data, status){
                DatatableReload();
...
//                }
            ...
            "drawCallback" : function(setting,data){
                ...
                var theTableName = "typecategorymanagement";
                 setTimeout(function(){
