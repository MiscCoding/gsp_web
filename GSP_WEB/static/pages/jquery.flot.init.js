...
! function($) {
	...
	FlotChart.prototype.init = function() {
		...
		//Pie graph data
		var pielabels = ["Series ", "Series ", "Series 3"];
		var datas = [40, 30, 15];
		var colors = ["#5fbeaa", "#6c85bd", "#34d3eb"];
		this.createPieGraph("#pie-chart #pie-chart-container", pielabels, datas, colors);

		//Pie graph data
		var pielabels = ["Series ", "Series2 ", "Series"];
		var datas = [20, 30, 15];
		var colors = ["#5fbeaa", "#6c85bd", "#34d3eb"];
		this.createPieGraph("#pie-chart2 #pie-chart-container2", pielabels, datas, colors);

		//Pie graph data
		var pielabels = ["Series1 ", "Series ", "Series"];
		var datas = [40, 50, 15];
		var colors = ["#5fbeaa", "#6c85bd", "#34d3eb"];
		this.createPieGraph("#pie-chart3 #pie-chart-container3", pielabels, datas, colors);
