...
class Integrated_Inter_Operation_Policy(db.Model, Serializer):
    ...
    Mal_IP_Type = db.Column(db.String(500), nullable=False)
    Target_IP_Type = db.Column(db.String(500), nullable=False)
    Mal_Type = db.Column(db.String(255), nullable=False)
