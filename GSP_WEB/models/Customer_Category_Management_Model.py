...
class Integrated_Customer_Category(db.Model, Serializer):
    __table_args__ = {"schema": "GSP_WEB"}
    __tablename__ = 'Customer_Category_Management'
    # region parameter input
    seq = db.Column(db.Integer, primary_key=True, autoincrement=True)
    Customer_Category = db.Column(db.String(255), unique=True, nullable=True)
    ...
    def __repr__(self):
        return '<Customer_Category_Management %r>' % (self.seq)
